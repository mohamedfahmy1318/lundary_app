...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Initial value)?  initial,TResult Function( _Loading value)?  loading,TResult Function( _Loaded value)?  loaded,TResult Function( _Submitting value)?  submitting,TResult Function( _SubmissionSuccess value)?  submissionSuccess,TResult Function( _Error value)?  error,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return submitting(_that);case _SubmissionSuccess() when submissionSuccess != null:
return submissionSuccess(_that);case _Error() when error != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Initial value)  initial,required TResult Function( _Loading value)  loading,required TResult Function( _Loaded value)  loaded,required TResult Function( _Submitting value)  submitting,required TResult Function( _SubmissionSuccess value)  submissionSuccess,required TResult Function( _Error value)  error,}){
final _that = this;
switch (_that) {
case _Initial():
...
return submitting(_that);case _SubmissionSuccess():
return submissionSuccess(_that);case _Error():
return error(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Initial value)?  initial,TResult? Function( _Loading value)?  loading,TResult? Function( _Loaded value)?  loaded,TResult? Function( _Submitting value)?  submitting,TResult? Function( _SubmissionSuccess value)?  submissionSuccess,TResult? Function( _Error value)?  error,}){
final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial(_that);case _Loading() when loading != null:
...
return loaded(_that.tickets);case _Submitting() when submitting != null:
return submitting();case _SubmissionSuccess() when submissionSuccess != null:
return submissionSuccess();case _Error() when error != null:
...
return loaded(_that.tickets);case _Submitting():
return submitting();case _SubmissionSuccess():
return submissionSuccess();case _Error():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Loaded&&const DeepCollectionEquality().equals(other._tickets, _tickets));
}
...
class _Submitting implements SupportState {
  const _Submitting();
...
@override
String toString() {
  return 'SupportState.submitting()';
}
...
class _SubmissionSuccess implements SupportState {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SubmissionSuccess);
}
...
@override
String toString() {
  return 'SupportState.submissionSuccess()';
}
