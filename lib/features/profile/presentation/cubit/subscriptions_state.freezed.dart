...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SubscriptionsState);
}
...
/// @nodoc
class $SubscriptionsStateCopyWith<$Res>  {
$SubscriptionsStateCopyWith(SubscriptionsState _, $Res Function(SubscriptionsState) __);
}


/// Adds pattern-matching-related methods to [SubscriptionsState].
extension SubscriptionsStatePatterns on SubscriptionsState {
...
return loaded(_that.plans,_that.mySubscriptions);case _Error() when error != null:
...
return loaded(_that.plans,_that.mySubscriptions);case _Error():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
class _Initial implements SubscriptionsState {
  const _Initial();
...
class _Loading implements SubscriptionsState {
  const _Loading();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Loaded&&const DeepCollectionEquality().equals(other._plans, _plans)&&const DeepCollectionEquality().equals(other._mySubscriptions, _mySubscriptions));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_plans),const DeepCollectionEquality().hash(_mySubscriptions));

@override
String toString() {
  return 'SubscriptionsState.loaded(plans: $plans, mySubscriptions: $mySubscriptions)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $SubscriptionsStateCopyWith<$Res> {
...
class _Error implements SubscriptionsState {
...
@override
String toString() {
  return 'SubscriptionsState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $SubscriptionsStateCopyWith<$Res> {
